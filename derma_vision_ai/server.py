"""
FastAPI REST API Server for DermaVision-AI: Clinical & Dermoscopic Dual-Modality Fusion Agent.
"""
...
def create_app():
    try:
        ...
        app = FastAPI(
            title="DermaVision-AI: Clinical & Dermoscopic Dual-Modality Fusion Agent",
            description="Fuses macro-photographs with polarized dermoscopy images, computing 7-point checklist scores and asymmetric border indices.",
        ...
        @app.get("/health")
        def health():
            return {"status": "HEALTHY", "system": "dermatology-multimodal-dermoscopy", "domain": "Dermatology AI", "version": "2.0.0-FRONTIER"}
