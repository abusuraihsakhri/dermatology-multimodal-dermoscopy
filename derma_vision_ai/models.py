"""
Data Models & Telemetry Definitions for DermaVision-AI: Clinical & Dermoscopic Dual-Modality Fusion Agent.
...
class AgentTelemetryAlert:
    ...
    standard_reference: str = "ISIC Dermoscopy Challenge Standards"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
