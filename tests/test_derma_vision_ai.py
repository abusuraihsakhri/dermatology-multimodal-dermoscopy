...
import pytest
from derma_vision_ai.models import FrontierPayload, ExecutionStatus
from derma_vision_ai.engine import FrontierDomainEngine
from derma_vision_ai.agents import MacroDermoscopyFusionAgent, SevenPointChecklistAgent, AsymmetryBorderScoreAgent, DermaVisionCoordinator
from derma_vision_ai.cli import main


def test_sub_agents():
    a1 = MacroDermoscopyFusionAgent()
...
def test_coordinator():
    ...
    assert "ISIC Dermoscopy Challenge Standards" in ans or "specifications" in ans
